...
public class Urna extends javax.swing.JFrame 
{
    ...
    DeputadoFederal df = new DeputadoFederal();
    DeputadoEstadual de = new DeputadoEstadual();
    ...
    public Urna() 
    {
        ...
        JMenuItem arquivo2 = new JMenuItem("Cruz Vermelha"); //subopção no menu
        try 
        {
            arquivo2.addActionListener(new ActionListener() 
            {
                public void actionPerformed(ActionEvent evt) 
                {
                    File file = new File("src\\pdf\\Partido equipe.pdf"); //abrir arquivo em pdf 
        ...
        JMenuItem arquivo3 = new JMenuItem("Tão tão distante"); //subopção no menu
        try 
        {
            arquivo3.addActionListener(new ActionListener() 
            {
                public void actionPerformed(ActionEvent evt) 
                {
                    File file = new File("src\\pdf\\Partido - Tão tão distante.pdf"); //abrir arquivo em pdf 
        ...
        //frame
        setTitle("Simulador - Urna Geral"); //titulo do frame
    ...
    private void initComponents() {
        ...
        NErrado.setBounds(80, 360, 270, 30);
        ...
        partido2.setBounds(140, 400, 160, 20);
        ...
        nome2.setBounds(140, 370, 190, 20);
        ...
        volt.setBackground(new java.awt.Color(0, 204, 51));
        volt.setFont(new java.awt.Font("Segoe UI Semibold", 1, 14)); // NOI18N
        volt.setText("CLIQUE AQUI");
        volt.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                voltActionPerformed(evt);
            }
        });
        getContentPane().add(volt);
        volt.setBounds(270, 460, 120, 30);
    ...
    public void cargos()
    {
        switch(ca)
        {
            case 1: //deputado federal
                df.df(c1, c2, c3, c4, imgC, libras, seuVoto, nome, nome2, partido, partido2, votoL, linha2, aperte, branco, laranja, verde, NErrado, votoNulo, numero, votoB); 
            break;
            
            case 2: //deputado estadual
                de.de(c1, c2, c3, c4, c5, imgC, libras, seuVoto, nome, nome2, partido, partido2, votoL, linha2, aperte, branco, laranja, verde, NErrado, votoNulo, numero);
            break;
            
            case 3: //senador
                s.s(c1, c2, c3, imgC, imgC2, imgS, nome2, partido, partido2, votoL, nome, linha2, seuVoto, aperte, branco, laranja, verde, NErrado, votoNulo, numero, libras);
            break;
            
            case 4: //governador
                g.g(c1, c2, imgC, imgC2,nome, nome2, partido, partido2, votoL, linha2, seuVoto, aperte, branco, laranja, verde,  NErrado, votoNulo, numero, libras);
            break;
            
            case 5: //presidente
                p.p(c1, c2, imgC, imgC2, nome, nome2, partido, partido2, votoL, linha2, seuVoto, aperte, branco, laranja, verde, NErrado, votoNulo, numero, libras);          
            break;
        }
    }
    ...
    public void novo()
    {
        switch(novo)
        {
            case 1: //deputado federal
                ...
                candi.setVisible(true);
                candi.setText("Deputado Federal");
                libras.setVisible(true);
            ...
            case 2: //deputado estadual
             seuVoto.setVisible(false);
                ...
                candi.setText("Deputado Estadual");
