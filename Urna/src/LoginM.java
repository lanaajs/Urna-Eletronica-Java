...
public class LoginM extends javax.swing.JFrame 
{
    public LoginM() 
    {
        ...
        //frame
        setTitle("Título de Eleitor - Municipal"); //titulo do frame
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        else
        {
            ...
            new UrnaM().setVisible(true); // Cria e exibe uma nova janela chamada 'Urna'
            ...
            new UrnaM().setVisible(false); // Cria e oculta uma nova janela chamada 'Urna'
        }
